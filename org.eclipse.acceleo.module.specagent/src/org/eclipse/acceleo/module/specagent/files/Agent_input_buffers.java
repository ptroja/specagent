...
/**
 * Entry point of the 'Agent_input_buffers' generation module.
 *
 * @generated
 */
public class Agent_input_buffers extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "agent_input_buffers";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "agent_input_buffers", };
	 ...
	 * @generated
	 */
	public Agent_input_buffers(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Agent_input_buffers(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Agent_input_buffers generator = new Agent_input_buffers(modelURI, folder, arguments);
