...
/**
 * Entry point of the 'Agent_task' generation module.
 *
 * @generated
 */
public class Agent_task extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "agent_task";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "agent_task", };
	 ...
	 * @generated
	 */
	public Agent_task(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Agent_task(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Agent_task generator = new Agent_task(modelURI, folder, arguments);
