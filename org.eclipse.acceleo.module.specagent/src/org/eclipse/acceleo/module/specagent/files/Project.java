...
/**
 * Entry point of the 'Project' generation module.
 *
 * @generated
 */
public class Project extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "project";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "project", };
	 ...
	 * @generated
	 */
	public Project(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Project(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Project generator = new Project(modelURI, folder, arguments);
