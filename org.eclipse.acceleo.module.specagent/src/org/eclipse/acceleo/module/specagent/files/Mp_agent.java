...
/**
 * Entry point of the 'Mp_agent' generation module.
 *
 * @generated
 */
public class Mp_agent extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "mp_agent";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "mp_agent", };
	 ...
	 * @generated
	 */
	public Mp_agent(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Mp_agent(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Mp_agent generator = new Mp_agent(modelURI, folder, arguments);
