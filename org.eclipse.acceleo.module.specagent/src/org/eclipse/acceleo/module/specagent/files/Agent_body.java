...
/**
 * Entry point of the 'Agent_body' generation module.
 *
 * @generated
 */
public class Agent_body extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "agent_body";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "agent_body", };
	 ...
	 * @generated
	 */
	public Agent_body(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Agent_body(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Agent_body generator = new Agent_body(modelURI, folder, arguments);
