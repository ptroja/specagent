...
/**
 * Entry point of the 'Logic_spec' generation module.
 *
 * @generated
 */
public class Logic_spec extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "logic_spec";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "logic_spec", };
	 ...
	 * @generated
	 */
	public Logic_spec(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Logic_spec(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Logic_spec generator = new Logic_spec(modelURI, folder, arguments);
