...
/**
 * Entry point of the 'Agent_spec' generation module.
 *
 * @generated
 */
public class Agent_spec extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "agent_spec";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "agent_spec", };
	 ...
	 * @generated
	 */
	public Agent_spec(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Agent_spec(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Agent_spec generator = new Agent_spec(modelURI, folder, arguments);
