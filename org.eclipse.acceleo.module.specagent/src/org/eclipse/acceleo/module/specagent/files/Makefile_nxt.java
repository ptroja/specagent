...
/**
 * Entry point of the 'Makefile_nxt' generation module.
 *
 * @generated
 */
public class Makefile_nxt extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "makefile_nxt";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "makefile_nxt", };
	 ...
	 * @generated
	 */
	public Makefile_nxt(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Makefile_nxt(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Makefile_nxt generator = new Makefile_nxt(modelURI, folder, arguments);
