...
/**
 * Entry point of the 'Effector_impl' generation module.
 *
 * @generated
 */
public class Effector_impl extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "effector_impl";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "effector_impl", };
	 ...
	 * @generated
	 */
	public Effector_impl(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Effector_impl(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Effector_impl generator = new Effector_impl(modelURI, folder, arguments);
