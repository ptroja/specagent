...
/**
 * Entry point of the 'Sensors_impl' generation module.
 *
 * @generated
 */
public class Sensors_impl extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "sensors_impl";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "sensors_impl", };
	 ...
	 * @generated
	 */
	public Sensors_impl(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Sensors_impl(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
    ...
    try {
      if (args.length < 2) {
        ...
        Sensors_impl generator = new Sensors_impl(modelURI, folder, arguments);
